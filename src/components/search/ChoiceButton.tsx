...
import { type ChatOption } from "../../types/search";
...
const ChoiceButton = ({ option, selected, onClick }: ChoiceButtonProps) => {
  return (
    <Button sx={getButtonSx(selected)} onClick={() => onClick(option)}>
      {option.label}
    </Button>
  );
};
