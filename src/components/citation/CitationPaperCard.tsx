...
import type { CitationPaperCard as CitationPaperCardType } from "../../types/citation";
import PaperTypeBadge from "../common/PaperTypeBadge";

interface CitationPaperCardProps {
  paper: CitationPaperCardType;
  isSelected?: boolean;
  onClick: () => void;
  onBookmark?: () => void;
}

const CitationPaperCard = ({
  paper,
  isSelected = false,
  onClick,
  onBookmark,
}: CitationPaperCardProps) => {
    ...
    return (
      <Box
        ...
        sx={{
          ...
          borderRadius: "12px",
          border: "1px solid",
          borderColor: isSelected ? "#3BA502" : "line.neutral",
...
export default CitationPaperCard;
